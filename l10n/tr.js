OC.L10N.register(
    ...
    "Your OpenWeatherMap API key is invalid. Contact your administrator to configure a valid API key in Additional Settings of the Administration" : "OpenWeatherMap API anahtarınız geçersiz. BT yöneticiniz ile görüşerek, Yönetici Ek Ayarları bölümünden geçerli bir API anahtarı yapılandırmasını isteyin",
