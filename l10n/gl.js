OC.L10N.register(
    ...
    "West" : "Oeste",
    "North-West" : "Noroeste",
    "Failed to get city weather informations. Please contact your administrator" : "Produciuse un fallo ao obter información meteorolóxica da cidade. Contacte coa administración desta instancia",
    "No city with this name found." : "Non se atopa unha cidade con este nome.",
    "Your OpenWeatherMap API key is invalid. Contact your administrator to configure a valid API key in Additional settings of the Administration" : "A súa chave da APi de OpenWeatherMap é incorrecta. Contacte coa administración desta instancia. para configurar unha chave de API válida nos Axustes adicionais de Administración",
    ...
    "Watch the weather directly on your Nextcloud." : "Vexa a meteoroloxía directamente no seu Nextcloud.",
